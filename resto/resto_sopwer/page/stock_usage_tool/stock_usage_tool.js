...
// Styles live in stock_usage_tool.css (Frappe auto-loads same-named CSS).
...
(function () {
  ...
  resto.stock_usage.Page = class {
    ...
    render_rm_summary(rows, idx) {
      ...
      console.log("ROWS SM SUMMARY", rows)
  ...
  renderTable();
    ...
    refreshSummary(me) {
      ...
      me.render_rm_summary(allRM, 999);  
    }
